                    ...
                    <div class="row align-items-center justify-content-between">
                        <div class="col-xl-3 col-lg-3 col-md-4 col-sm-4">
                            <div class="header__info">
                                <div class="logo">
                                    <a href="{{ url('/') }}" class="logo-image"><img src="{{ asset('assets/img/logo/brand.png') }}" alt="logo"></a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="d-flex  flex-wrap ">
                            <div class="header-inner-start
                                ...
                                <div class="header__currency border-right">
                                    <div class="s-name">
                                             <span>
                                                <a href="#vector-art">Vector Art</a>
                                             </span>
                                    </div>
                                </div>
                                <div class="border-right header__currency">
                                    <div class="s-name">
                                            <span>
                                                <a href="#patches">Patches/Labels</a>
                                            </span>
                                    </div>
                                </div>
                                <div class="s-name header__currency">
                                    <div>
                                           <span>
                            ...
                            <div class="header-action">
                                <div class="block-userlink ">
                                    <a class="icon-link pe-2" href="{{ route('login') }}">
                                        ...
                                        <span class="text">
                                            <span class="sub pt-1">Login</span>
                                        </span>
                                        <!-- My Account </span> -->
                                    </a>
                                </div>
                                <div class="block-userlink">
                                    <a class="icon-link pe-2" href="{{ route('register') }}">
                                        <i class="flaticon-user"></i>
                                        <span class="text">
                                            <span class="sub pt-1">Registration</span>
                                        </span>
                                    </a>
                                </div>
                                <div class="block-userlink">
                                    <a class="icon-link" href="{{ route('contact') }}">
                                        <iconify-icon icon="ph:phone-light"></iconify-icon>                                    <span class="text">
                                            <span class="sub pt-1">Contact Us</span>
                                        </span>
                                    </a>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-xl-12">
                                ...
                                <div class="payment-image text-center mb-25">
                                    <a href="contact.html"><img src="{{ asset('assets/img/payment/payment.png') }}" alt=""></a>
                                </div>
                                <div class="copy-right-area text-center">
                                    <p>Copyright © <span>Client</span> All Rights Reserved. Powered by <a href="s-rehman.com"><span class="main-color">Shafiq-ur-Rehman</span></a></p>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/iconify/2.0.0/iconify.js" integrity="sha512-vX/u24VoVNEFnY4hejf35cn0a3id3sciX/7WHtSO0DjjeViFQI0OgpGdQykHTjW+IKpLRDN6jWwvnGX98QiRIA==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
