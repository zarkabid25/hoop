    ...
    <div style="margin-top: 15px;">
        <table style="border: 1px solid black; border-collapse: collapse; width: 100%">
            ...
            <tr style="border: 1px solid black">
                ...
                <td style="text-align: center; border: 1px solid black">{{ $invoiceData->format ?? '--' }}</td>
            </tr>
            ...
            <tr>
                ...
                <td style="text-align: center; border: 1px solid black">{{ $invoiceData->order_status ?? '--' }}</td>
            ...
            <tr>
                ...
                <th style="border: 1px solid black" colspan="3">Special Instruction</th>
            </tr>

            <tr>
                <td style="text-align: center; border: 1px solid black; padding: 3px" colspan="2">{{ $invoiceData->tracking_id ?? '--' }}</td>
                <td style="text-align: center; border: 1px solid black" colspan="3">{{ $invoiceData->special_instruct ?? '--' }}</td>
            </tr>
